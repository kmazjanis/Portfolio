...
for (let i = 0; i < 4; i++) {
  document.getElementById("NR2Data").innerHTML +=
    "2. Testing loop from 0 to 4, + var result: " + i + " - " + name + "<br>";
}
...
document.getElementById("NR5NodeCount").innerHTML =
  "This doc contains<b> " +
  myNodeList.length +
  " paragraphs</b>.(And growing!)";
...
function clickCounter() {
  if (typeof Storage !== "undefined") {
    ...
    document.getElementById("counterResult").innerHTML =
      "You have clicked the button " + localStorage.clickcount + " times.";
  }
}
...
for (attribute in sharky) {
  document.getElementById("NR9Data").innerHTML +=
    attribute + ":" + sharky[attribute] + " ";
}
...
function reverseString(str) {
  ...
  document.getElementById("NR13Data").innerHTML +=
    "Reversed var string: " + reversed + "</br>";
  return (document.getElementById("NR13Data").innerHTML +=
...
function reversedMuch() {
  ...
  var reversed3 = reversed2
    .split("")
    .reverse()
    .join("");
  document.getElementById("demo").innerHTML +=
    "Reversed String: " + reversed3 + "</br>";
}
...
function factorializeThis() {
  ...
  return (document.getElementById("FactoResult").innerHTML +=
    '<div id="FactoResult"> This is the result man: <b>' +
    startNumber +
    "<b></div>");
}
...
function PalindromeThis() {
  ...
  if (reversedText == smoothText) {
    return (document.getElementById("PalindromeResult").innerHTML +=
      "<div id='PalindromeResult'><b>It's Palindrome<b></div>");
  } else {
    return (document.getElementById("PalindromeResult").innerHTML +=
      "<div id='PalindromeResult'><b>It's NOT Palindrome<b></div");
  }
}
...
function CondOper() {
  ...
  let getNumberRes =
    getNumber == 0 ? "zero!" : getNumber > 0 ? "positive" : "negative";
...
const redTriangle = document.querySelector("#red");
const blueTriangle = document.querySelector("#blue");
const greenTriangle = document.querySelector("#green");
const yellowTriangle = document.querySelector("#yellow");

function game(userChoise) {
  console.log("whooot" + userChoise);
}

redTriangle.addEventListener("click", function() {
  game("R");
});

blueTriangle.addEventListener("click", function() {
  game("B");
});

greenTriangle.addEventListener("click", function() {
  game("G");
});

yellowTriangle.addEventListener("click", () => {
  game("Y");
});
